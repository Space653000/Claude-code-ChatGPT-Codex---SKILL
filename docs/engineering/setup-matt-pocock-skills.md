...
`setup-matt-pocock-skills` automatically when the catalog is newly installed or
the repository lacks tracker and domain-doc configuration. Typing
`/setup-matt-pocock-skills` remains optional.

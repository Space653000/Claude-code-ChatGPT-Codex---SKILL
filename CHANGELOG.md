...
- Import the complete `mattpocock/skills` snapshot at commit `5b15a47`.
- Expose all 36 active skills through Claude Code and Codex plugin manifests.
- Add a shared Git marketplace and cross-platform installation instructions.

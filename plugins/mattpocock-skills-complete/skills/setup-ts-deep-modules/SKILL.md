...
description: Experimental TypeScript architecture setup using dependency-cruiser. Use when the user wants package internals hidden behind entry points and deep-module boundaries enforced automatically.
---

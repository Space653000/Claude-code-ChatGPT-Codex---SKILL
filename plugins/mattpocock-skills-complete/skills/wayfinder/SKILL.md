---
name: wayfinder
description: Map work too large for one agent session into linked decision tickets and resolve the unknowns incrementally. Use when a goal spans many sessions and the route to implementation is still unclear.
---

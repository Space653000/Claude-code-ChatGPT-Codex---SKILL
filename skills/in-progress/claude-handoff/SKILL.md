---
name: claude-handoff
description: Experimental Claude Code background handoff. Use when the user asks a fresh background Claude agent to continue the current conversation immediately.
